          ...
          `}
                >
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-between text-justify flex-1">
                        ...
                        <button className="block bg-[#A580FF] text-white px-4 py-2 rounded hover:bg-[#A580FF]/50 self-center md:self-start mx-auto text-md md:text-lg lg:text-xl xl:text-2xl">
                            Know more
                        </button>
                    </div>
                    {/* Image */}
