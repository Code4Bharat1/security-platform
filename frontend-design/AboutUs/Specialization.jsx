export default function Specialiazation() {
    return (
        <div className="py-10 min-h-screen px-4 sm:px-8 overflow-x-hidden bg-black">
            <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-10 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center gap-8 w-full md:w-1/2">
                    <div className="flex flex-col md:flex-row md:flex-wrap gap-6 justify-center w-full max-w-2xl mx-auto">
                        <Card
                            title="OUR MISSION"
                            hrColorDir="to-r"
                            listItem={[
                    ...
                    <div className="w-full max-w-md mx-auto">
                        <Card
                            ...
                            cardNumber={"translate-y-2 scale-x-105"}
                        />
                    </div>
                </div>
            </div>
