          ...
          <div className="tool-detail-hero flex items-center justify-start gap-4 mb-6">
            ...
            <div className="text-left">
              <h1 className="text-3xl font-bold text-white">
                CSRF Security Analyzer
              </h1>
              <p className="text-gray-400 text-sm mt-1">
                Identify and prevent Cross-Site Request Forgery vulnerabilities
                in your code
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-900 rounded-xl border border-white-700 p-6">
                ...
                <div className="rounded-lg p-4 border border-white-700 bg-gray-800">
                  ...
                  <ul className="space-y-1 text-xs">
                    <li className="flex items-center gap-2 text-gray-400">
                      <span>
                        {result.breakdown?.tokenPresentOK ? "✅" : "❌"}
                      </span>{" "}
                      Token present (+30)
                    </li>
                    <li className="flex items-center gap-2 text-gray-400">
                      <span>
                        {result.breakdown?.cookieSameSiteOK ? "✅" : "❌"}
                      </span>{" "}
                      Cookie SameSite (+30)
                    </li>
                    <li className="flex items-center gap-2 text-gray-400">
                      <span>
                        {result.breakdown?.originRefererOK ? "✅" : "❌"}
                      </span>{" "}
                      Origin/Referrer policy (+30)
                    </li>
                    <li className="flex items-center gap-2 text-gray-400">
                      <span>
                        {result.breakdown?.tokenRandomnessOK ? "✅" : "❌"}
                      </span>{" "}
                      Token randomness (+10)
                    </li>
                  </ul>
            ...
            {result ? (
              ...
              >
                <div
                  className={`flex items-center gap-3 mb-4 text-sm font-semibold ${
              ...
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm">
                  Upload your code to begin security analysis
                </p>
                <p className="text-xs mt-1 text-gray-600">
                  Supported formats: HTML, JS, JSX, TS, TSX
                </p>
              </div>
            )}
          </div>
