  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl items-start h-full">
        {/* Non-Tech Card */}
        <div className="bg-white shadow-md rounded-lg p-6" onClick={()=>renderCards("non-tech")}>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <p className="text-gray-600">Tools for Professionals.</p>
          ...
          {showTechDetails && (
            <div className="mt-4 space-y-3">
              ...
              {/* Forensic */}
              <div className="p-4 bg-purple-100 rounded-lg" onClick={()=>renderCards("tech-for")}>
