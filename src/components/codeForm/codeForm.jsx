...
export default function CodeForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_PROD_API_URL}/analyze/analyzeCode`, {
        method: "POST",
        headers: {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-xl mt-5">
      <img src="/tools/card-images/code.png" alt="verify" className="w-16 h-20 mb-4 mt-7" />
      ...
      <div className="mb-4">
        <textarea
          ...
          value={code}
          onChange={(e) => setCode(e.target.value.trim())}         rows={10}
