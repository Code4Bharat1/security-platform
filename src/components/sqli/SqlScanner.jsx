...
export default function SqlScanner() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      setResult(data.message || "✅ Scan complete. No SQLi found.");
    } catch (err) {
      setResult("❌ Failed to scan for SQL Injection.");
    }
