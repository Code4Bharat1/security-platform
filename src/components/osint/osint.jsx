      ...
      <div className="tool-detail-shell">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
          ...
          <div className="space-y-6">
            ...
            {error && (
              <div className="p-4 rounded-xl border border-rose-500/20 bg-rose-955/10 text-rose-400 text-xs font-mono flex items-start gap-2">
              ...
              <div className="bg-zinc-950/20 backdrop-blur-md border border-zinc-800/80 rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.2)] hover:border-emerald-500/10 transition-all duration-300 space-y-5">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="p-4.5 rounded-xl border border-emerald-500/20 bg-emerald-950/10 text-emerald-400 shadow-[inset_0_0_12px_rgba(16,185,129,0.02)] transition-all duration-300 hover:scale-[1.01] flex flex-col justify-between gap-1">
                    <span className="text-[9px] uppercase font-mono tracking-widest text-zinc-500 font-semibold">Total Audits</span>
                    <span className="text-xl font-bold font-mono">{results?.details?.length || 0}</span>
                  </div>
                  <div className="p-4.5 rounded-xl border border-rose-500/20 bg-rose-955/10 text-rose-400 shadow-[inset_0_0_12px_rgba(244,63,94,0.02)] transition-all duration-300 hover:scale-[1.01] flex flex-col justify-between gap-1">
                    <span className="text-[9px] uppercase font-mono tracking-widest text-zinc-500 font-semibold">Leaks Found</span>
                    <span className="text-xl font-bold font-mono">{foundCount}</span>
                  </div>
                  <div className="p-4.5 rounded-xl border border-emerald-500/20 bg-emerald-950/10 text-emerald-400 shadow-[inset_0_0_12px_rgba(16,185,129,0.02)] transition-all duration-300 hover:scale-[1.01] flex flex-col justify-between gap-1">
                    <span className="text-[9px] uppercase font-mono tracking-widest text-zinc-500 font-semibold">Clean Checks</span>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-zinc-800/80 bg-zinc-950/20 backdrop-blur-md rounded-2xl p-6 space-y-4 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              ...
              <ul className="space-y-3.5 list-none pl-0">
                {[
                  "Credential Stuffing: Breached usernames are matched against common leak catalogs to test reuse.",
                  "Dossier Correlation: Cross-referencing profiles across platforms allows threat modeling.",
                  "Mitigation Strategy: Implement unique randomized passphrases and enable secondary authentication methods (MFA).",
                ].map((text, i) => (
