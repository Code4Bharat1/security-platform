            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>{ccToFlag(summary?.country)} {summary?.country || '—'}</span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-wrap items-center">
                    {summary?.status?.length ? (
                      summary.status.map((s, i) => (
                        <span key={i} className="ml-1 inline-block px-2 py-0.5 text-xs rounded-full font-semibold bg-red-500 text-white">
                          {s}
                        </span>
                      ))
                    ) : (
