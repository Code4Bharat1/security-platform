    ...
    <div className="bg-black min-h-screen text-white flex flex-col items-center justify-center p-6">
      ...
      <div className="flex flex-col items-center justify-center gap-6 mb-10 text-center">
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-full border-4 border-red-600 flex items-center justify-center text-2xl font-bold">
            img
          </div>
          <div>
      ...
      {/* Main Analyzer Box */}
      <div className="bg-black border border-white rounded-2xl p-7 w-full max-w-3xl">
        
        {/* Paste Code */}
        <label className="block font-semibold mb-3 text-white text-lg sm:text-xl md:text-2xl">
          Paste Code:
        </label>
        <textarea
          className="w-full h-40 p-3 border border-white bg-black text-red-500 rounded-md mb-4 resize-none placeholder-red-500 text-lg sm:text-xl md:text-2xl"
        ...
        <div className="mb-4 flex items-center space-x-4">
          <label className="font-semibold text-white text-lg sm:text-xl md:text-2xl whitespace-nowrap">
            Upload File:
          </label>
          <input
            type="file"
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={loading}
            className="bg-red-600 text-white font-bold px-6 py-2 rounded-md hover:bg-red-700 transition"
          >
        ...
        {result && (
          <div className="mt-6 bg-gray-900 border border-gray-700 p-4 rounded-md">
            <h3 className="font-bold text-lg mb-2 text-white">Scan Result:</h3>
            {result.issues?.length === 0 ? (
              <p className="text-green-500">✅ No vulnerabilities found!</p>
            ) : (
