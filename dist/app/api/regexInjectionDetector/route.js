...
function _POST() {
  _POST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req) {
    var _yield$req$json, code, lines, issues, fixes, _t;
      ...
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          lines.forEach(function (line, idx) {
            ...
            var unsafeRegexMatch = line.match(/new RegExp\((.+)\)/);
            if (unsafeRegexMatch) {
              var inputVar = unsafeRegexMatch[1].trim();
              ...
              fixes.push("// Suggested fix for line ".concat(idx + 1, ":"));
              fixes.push("const safeInput = ".concat(inputVar, ".replace(/[.*+?^", '{', "()|[\\]\\\\]/g, '\\\\$&');"));
            ...
            if (line.includes('(.*)') || line.includes('(.*?)')) {
              ...
              fixes.push("// Review regex pattern on line ".concat(idx + 1, " for ReDoS risks"));
            }
          });
