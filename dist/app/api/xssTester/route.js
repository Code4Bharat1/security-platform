...
function _POST() {
  _POST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req) {
    var _yield$req$json, url, param, payload, urlObj, response, text, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          param = _yield$req$json.param;
          payload = _yield$req$json.payload;
          ...
          _context.n = 2;
          return (0, _nodeFetch["default"])(urlObj.toString());
        case 2:
          response = _context.v;
          _context.n = 3;
