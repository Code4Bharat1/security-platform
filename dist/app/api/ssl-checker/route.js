...
function _POST() {
  _POST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(request) {
    var _yield$request$json, url, formattedUrl, sslData, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          formattedUrl = url.replace(/^https?:\/\//, "").split("/")[0];
          console.log("Processing URL:", formattedUrl); // Debugging Log

          // Perform the SSL check on the user-provided URL
          _context.n = 3;
          return (0, _sslChecker["default"])(formattedUrl);
        case 3:
          sslData = _context.v;
          return _context.a(2, new Response(JSON.stringify(sslData), {
            status: 200
          }));
        case 4:
          _context.p = 4;
          _t = _context.v;
          console.error("SSL Checker Error:", _t); // Log the error for debugging
