...
function _POST() {
  _POST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req) {
    var _yield$req$json, code, eslint, results, issues, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          return _context.a(2, new _nodeFetch.Response(JSON.stringify({
        ...
        case 3:
          results = _context.v;
          issues = results.flatMap(function (result) {
        ...
        case 4:
          _context.p = 4;
          _t = _context.v;
          console.error("ESLint API error:", _t);
          return _context.a(2, new _nodeFetch.Response(JSON.stringify({
            error: _t.message
          }), {
            status: 500
