...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // /app/api/techdetect/route.js
function POST(_x) {
  return _POST.apply(this, arguments);
}
function _POST() {
  _POST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req) {
    var _yield$req$json, url, res, html, headers, tech, uniqueTech, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 4:
          ...
          tech = []; // --- From headers ---
          if (headers['x-powered-by']) tech.push("X-Powered-By: ".concat(headers['x-powered-by']));
          if (headers['server']) tech.push("Server: ".concat(headers['server']));
          ...
          uniqueTech = _toConsumableArray(new Set(tech)); // remove duplicates
        ...
        case 5:
          ...
          _t = _context.v;
          return _context.a(2, _server.NextResponse.json({
            error: "Unable to fetch or analyze the website."
          }, {
            status: 500
          }));
      }
