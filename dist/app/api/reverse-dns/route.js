...
function _POST() {
  _POST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(request) {
    var _yield$request$json, ip, domains, _t, _t2;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 3:
          _context.p = 3;
          _context.n = 4;
          return _promises["default"].reverse(ip);
        case 4:
          domains = _context.v;
          if (!(domains.length === 0)) {
            _context.n = 5;
        ...
        case 6:
          ...
          _t = _context.v;
          return _context.a(2, new Response(JSON.stringify({
            error: 'No PTR record found or DNS lookup failed'
          }), {
            status: 404
          }));
        case 7:
